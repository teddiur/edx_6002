...
class Robot(object):
    ...
    def __init__(self, room, speed):
        ...
        self.pos = Position(pos.getX(), pos.getY())
...
#print(runSimulation(5, 1.0, 20, 20, 0.75, 30, StandardRobot))
...
#print(runSimulation(5, 1.0, 20, 20, 0.75, 1, RandomWalkRobot))
...
#showPlot1("Average clean time vs number of robots", "Number of robots", "Time")
...
showPlot2("Aspect ratios vs time", "Aspect ratio (width/height)", "Time")
